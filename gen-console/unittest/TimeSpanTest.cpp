...
TEST(TimeSpanTest, Constructor_hms_positive)
{
	...
	EXPECT_EQ(test.Ticks(), (((((hours * WORLD_TIME_MINUTESPERHOUR) + minutes) * WORLD_TIME_SECONDSPERMINUTE) + seconds) * WORLD_TIME_TICKSPERSECOND));
}
...
TEST(TimeSpanTest, Constructor_dhms_positive)
{
	...
	EXPECT_EQ(test.Ticks(), (((((((days * WORLD_TIME_HOURSPERDAY) + hours) * WORLD_TIME_MINUTESPERHOUR) + minutes) * WORLD_TIME_SECONDSPERMINUTE) + seconds) * WORLD_TIME_TICKSPERSECOND));
}
...
TEST(TimeSpanTest, Constructor_ydhms_positive)
{
	...
	EXPECT_EQ(test.Ticks(), (((((((((years * WORLD_TIME_DAYSPERYEAR) + days) * WORLD_TIME_HOURSPERDAY) + hours) * WORLD_TIME_MINUTESPERHOUR) + minutes) * WORLD_TIME_SECONDSPERMINUTE) + seconds) * WORLD_TIME_TICKSPERSECOND));
}
...
TEST(TimeSpanTest, TotalSeconds_positive)
{
	...
	__int64 seconds = 12UL;
	TimeSpan test(years, days, hours, minutes, seconds);
	EXPECT_EQ(test.TotalSeconds(), ((((((((years * WORLD_TIME_DAYSPERYEAR) + days) * WORLD_TIME_HOURSPERDAY) + hours) * WORLD_TIME_MINUTESPERHOUR) + minutes) * WORLD_TIME_SECONDSPERMINUTE) + seconds));
}
...
TEST(TimeSpanTest, TotalMinutes_positive)
{
	...
	__int64 seconds = 12UL;
	TimeSpan test(years, days, hours, minutes, seconds);
	EXPECT_EQ(test.TotalMinutes(), ((((((years * WORLD_TIME_DAYSPERYEAR) + days) * WORLD_TIME_HOURSPERDAY) + hours) * WORLD_TIME_MINUTESPERHOUR) + minutes));
}
...
TEST(TimeSpanTest, TotalHours_positive)
{
	...
	__int64 seconds = 12UL;
	TimeSpan test(years, days, hours, minutes, seconds);
	EXPECT_EQ(test.TotalHours(), ((((years * WORLD_TIME_DAYSPERYEAR) + days) * WORLD_TIME_HOURSPERDAY) + hours));
}
