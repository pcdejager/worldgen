...
{
    IndividualPtr father = std::make_shared<Individual>(Parents::CreateNoParents(), WorldTime(123UL));
    IndividualPtr mother = std::make_shared<Individual>(Parents::CreateNoParents(), WorldTime(321UL));
